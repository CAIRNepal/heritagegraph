  ...
  if (error || !record) {
    return (
      <div className="px-4 lg:px-6 py-12 text-center space-y-4">
        ...
        <Button
          variant="outline"
          onClick={() => router.push("/knowledge/structure")}
        >
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-6">
              ...
              <div className="flex gap-2 flex-shrink-0">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    router.push("/contribute/structure")
                  }
                >
                  Add Info
                </Button>
      ...
      <Card>
        <CardContent className="py-12 text-center space-y-3">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push("/contribute/ritual")}
          >
            Add Ritual Event
          </Button>
        </CardContent>
            ...
            <div key={event.id} className="relative group">
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(`/knowledge/ritual/view/${event.id}`)
                  }
                >
