...
const knowledgeDomains = [
  { name: 'Cultural Entities', icon: IconBuildingCommunity, href: '/knowledge/entity' },
  { name: 'Historical Persons', icon: IconUsers, href: '/knowledge/person' },
  { name: 'Heritage Locations', icon: IconMapPin, href: '/knowledge/location' },
  { name: 'Cultural Events', icon: IconCalendarEvent, href: '/knowledge/event' },
  { name: 'Traditions & Practices', icon: IconFlame, href: '/knowledge/tradition' },
  { name: 'Documentary Sources', icon: IconFileDescription, href: '/knowledge/source' },
];
