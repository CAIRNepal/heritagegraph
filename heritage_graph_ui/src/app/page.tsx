      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-blue-100 text-blue-900 font-sans scroll-smooth overflow-x-hidden">
        ...
        <motion.header
          className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
            isScrolled
              ? 'bg-white/80 backdrop-blur-xl border-b border-blue-200'
              : 'bg-transparent'
          }`}
          ...
          <section id="explore" className="relative py-24 px-6">
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                >
                  From centuries-old temples to rare manuscripts, we document and
                  digitize Nepal's diverse cultural assets using cutting-edge knowledge
                  graph technology.
                </motion.p>
              </motion.div>
          ...
          >
            <div className="relative max-w-5xl mx-auto">
              ...
              >
                ...
                >
                  Whether you're a researcher, student, or local expert, your insights
                  are valuable in helping us build a richer and more reliable cultural
                  knowledge graph. We actively welcome interdisciplinary research on —
                  or built upon — the HeritageGraph platform.
                </motion.p>
          ...
          >
            <div className="relative max-w-4xl mx-auto text-center">
              ...
              >
                ...
                >
                  Help us safeguard Nepal's intangible and tangible heritage —
                  digitally, collaboratively.
                </motion.p>
