...
// Type definition for preservation items
  ...
  const preservationItems: PreservationItem[] = [
    {
      ...
      description: "Sacred architecture spanning centuries of Nepali craftsmanship and spiritual heritage.",
      gradient: "from-blue-400 to-sky-500",
    },
    {
      icon: Scroll,
      title: "Sacred Manuscripts",
      description: "Rare texts and documents preserving ancient knowledge and cultural wisdom.",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: Globe,
      title: "Living Traditions",
      description: "Festivals, rituals, and cultural practices that continue to thrive today.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-blue-100 text-blue-900 font-sans scroll-smooth overflow-x-hidden">
      ...
      <motion.header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled ? "bg-white/80 backdrop-blur-xl border-b border-blue-200" : "bg-transparent"
        }`}
            ...
            <Sheet>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="text-blue-800 hover:bg-blue-100/50"
                  aria-label="Open navigation menu"
                >
                  <Menu className="h-5 w-5" />
                </Button>
              </SheetTrigger>
              <SheetContent side="right" className="bg-white/90 backdrop-blur-xl border-blue-200 text-blue-900">
                <nav className="mt-8 flex flex-col gap-6">
                  {["Explore", "About", "Contact"].map((item) => (
                    <a
                      key={item}
                      href={`#${item.toLowerCase()}`}
                      className="text-lg text-blue-800 hover:text-blue-600 transition-all duration-300"
                    >
                      {item}
                    </a>
                  ))}
    ...
    Understanding Identity, Safeguarding the Future
        ...
        <section id="explore" className="relative py-24 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <motion.h2 variants={fadeInUp} className="text-4xl md:text-5xl font-bold mb-6 text-blue-900">
                What We{" "}
                <span className="text-transparent bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text">
                  Preserve
                </span>
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-xl text-blue-700 max-w-3xl mx-auto">
                From centuries-old temples to rare manuscripts, we document and digitize Nepal's diverse cultural assets
                using cutting-edge knowledge graph technology.
              </motion.p>
            </motion.div>
        ...
        {/* About Section */}
        <section id="about" className="relative py-24 px-6 bg-gradient-to-br from-blue-100 to-sky-100">
          <div className="relative max-w-5xl mx-auto">
            ...
            >
              <motion.h2 variants={fadeInUp} className="text-4xl md:text-5xl font-bold text-blue-900">
                How You Can{" "}
                <span className="text-transparent bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text">
                  Contribute
                </span>
              </motion.h2>
              <motion.p variants={fadeInUp} className="text-xl text-blue-800 max-w-4xl mx-auto leading-relaxed">
                Whether you're a researcher, student, or local expert, your insights are valuable in helping us build a
                richer and more reliable cultural knowledge graph. We actively welcome interdisciplinary research on — or
        ...
        <section className="relative py-24 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <motion.h2 variants={fadeInUp} className="text-3xl font-bold text-blue-800">
                An initiative by
              </motion.h2>
        ...
        {/* CTA Section */}
        <section id="contact" className="relative py-24 px-6 bg-gradient-to-br from-blue-100 to-sky-100">
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <motion.p variants={fadeInUp} className="text-xl text-blue-800 max-w-2xl mx-auto">
        ...
        <section className="relative py-24 px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              variants={staggerContainer}
            >
              <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-bold text-center mb-12 text-blue-900">
                Frequently Asked{" "}
                <span className="text-transparent bg-gradient-to-r from-blue-600 to-sky-500 bg-clip-text">
                  Questions
                </span>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      question: "How does this help preserve cultural heritage, which is a physical task?",
                      answer:
                    ...
                    },
                    {
                      ...
                      answer: "Yes, the project is open-source and available on GitHub. Contributions from the community are welcome.",
                    },
                    {
                      value: "research-idea",
                      question: "I have a research idea, but I'm not from an AI background. Can I still contribute?",
                      answer:
      ...
      <footer className="relative py-12 px-6 border-t border-blue-200 bg-white/80 backdrop-blur-sm">
        <div className="relative max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-blue-700 text-center">© {new Date().getFullYear()} HeritageGraph. All rights reserved.</p>
            <div className="flex items-center gap-4">
              <Button variant="ghost" size="icon" className="text-blue-700 hover:text-blue-600 hover:bg-blue-100/50">
