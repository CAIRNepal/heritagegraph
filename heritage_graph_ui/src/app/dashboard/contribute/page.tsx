...
const steps: { title: string; fields: FieldConfig[] }[] = [
  {
    ...
    fields: [
      ...
      { name: "description", label: "Description", type: "textarea", placeholder: "Provide detailed description..." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "Monument_height_approximate", label: "Monument Height (Approx.)" },
  ...
  return (
    <>
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-bold tracking-tight">Submit a Cultural Heritage Entry</h1>
          <p className="text-muted-foreground mt-1 text-sm">Share a site, object, ritual, or tradition worth preserving.</p>
        </div>
