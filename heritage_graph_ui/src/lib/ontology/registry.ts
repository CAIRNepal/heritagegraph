...
const heritageAssertion: OntologyClass = {
  ...
  fields: [
    ...
    { key: "source_citation", label: "Source Citation", type: "textarea", section: "provenance", order: 1, placeholder: "e.g., Wright, Daniel (1877). History of Nepal, p. 42", description: "Inline citation for the source of this assertion" },
    { key: "contributed_by", label: "Attributed To", type: "text", section: "provenance", order: 2, placeholder: "e.g., Dr. Shaphalya Amatya", description: "Person or contributor who made this assertion" },
    { key: "confidence", label: "Confidence Level", type: "select", section: "quality", order: 1, options: [
      { value: "certain", label: "Certain" },
      { value: "likely", label: "Likely" },
      { value: "uncertain", label: "Uncertain" },
      { value: "speculative", label: "Speculative" },
    ], description: "Contributor's confidence in this claim" },
  ...
  columns: [
    ...
    { key: "confidence", label: "Confidence", sortable: true, visible: true, format: "badge" },
