...
const colorClasses = {
  purple: {
    ...
    bg: 'bg-gradient-to-b from-hero-from to-white dark:from-hero-from dark:to-gray-950',
    iconBg: 'bg-primary/10 dark:bg-primary/10',
    iconText: 'text-primary dark:text-primary',
    infoBorder: 'border-primary/30 dark:border-primary/30',
    infoBg: 'bg-primary/10 dark:bg-primary/10',
    infoTitle: 'text-primary dark:text-primary',
    dot: 'bg-primary/10',
  },
  blue: {
    border: 'border-primary/30 dark:border-primary/30',
