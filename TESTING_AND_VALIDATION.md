...
### 4.2 Django unit / integration tests
...
### 4.4 What the E2E command checks (mapping)

| Step | Validates |
|------|-----------|
| `api_post_*` | Same routes as UI: `/api/v1/cidoc/locations/`, `structures/`, `persons/` |
