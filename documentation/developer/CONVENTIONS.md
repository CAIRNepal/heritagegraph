...
| `documentation/developer/SKILLS.md` | AI agents | Features added, removed, or status changes |
| `documentation/ontology/ONTOLOGY.md` | AI agents + humans | LinkML registry types, enums, CIDOC alignment change |
| `documentation/contribution/FORMS.md` | AI agents + humans | Form/registry workflow changes |
| `ARCHITECTURE.md` | AI agents + humans | System design or data flow changes |
| `documentation/developer/CONVENTIONS.md` | AI agents | Style rules change |
| `documentation/TROUBLESHOOTING.md` | AI agents + humans | New bugs found or fixed |
| `documentation/deployment/DEPLOYMENT.md` | Humans (ops/devops) | Deployment process changes |
