...
**Example:** Translating the Team page (`/team`)
...
| Team | `/team` | `team` | Add keys + wire |
| Contribute | `/contribute` | `contribute` | Wire existing keys + add missing ones |
| Progression | `/progression` | `progression` | Add keys + wire |
| Leaderboard | `/leaderboard` | `leaderboard` | Add keys + wire |
| Notifications | `/notification` | `notifications` | Add keys + wire |
| Knowledge pages | `/knowledge/*` | `knowledge` | Wire existing keys |
| Curation pages | `/curation/*` | `review` | Wire existing keys + add missing ones |
| Community pages | `/community/*` | `community` | Add keys + wire |
| Graph View | `/graphview` | `graphview` | Add keys + wire |
