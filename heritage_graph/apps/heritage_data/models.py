...
class Submission(models.Model):
    ...
    Inscription_identification_number = models.CharField(max_length=255, null=True, blank=True)
    ...
    Monument_height_approximate = models.CharField(max_length=255, null=True, blank=True)
    ...
    Municipality_village_council = models.CharField(max_length=255, null=True, blank=True)
    ...
    Number_of_wood_carved_windows = models.CharField(max_length=255, null=True, blank=True)
