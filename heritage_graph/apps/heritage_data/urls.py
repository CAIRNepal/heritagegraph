...
urlpatterns = [
    ...
    path('submissions/<str:submission_id>/', views.SubmissionDetailView.as_view(), name='submission-detail'),
    path('form-submit/', views.FormSubmissionAPIView.as_view(), name='create_submission'),
    path('moderation/<int:pk>/', views.ModerationReviewView.as_view(), name='moderation-review'),
    ...
    path('submission-suggestions/', views.SubmissionSuggestionViewSet.as_view({'post': 'create'}), name='submission-suggestion-create'),
    path('submission-suggestions/<int:pk>/approve/', views.SubmissionSuggestionViewSet.as_view({'post': 'approve'}), name='submission-suggestion-approve'),
    path('submission-suggestions/<int:pk>/reject/', views.SubmissionSuggestionViewSet.as_view({'post': 'reject'}), name='submission-suggestion-reject'),

    path('submissions/<str:submission_id>/versions/', views.SubmissionVersionListView.as_view(), name='submission-versions-list'),
    path('submissions/<str:submission_id>/edit-suggestions', views.SubmissionEditSuggestionListView.as_view(), name='submission-edit-suggestions-list'),

    path('submissions/ids', views.SubmissionIdListView.as_view(), name='submission_ids'),
