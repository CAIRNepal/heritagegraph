export const DUMMY_RESPONSES: {
  ...
  },
  {
    ...
    response: 'Taking you to the HeritageGraph app.',
    nav: '/',
  },
  {
    keywords: ['contribute', 'add entity', 'how do i add'],
    response:
      "To contribute, open the main app and go to [[Contribute]] — you'll fill in a structured form and your submission enters the curation queue for review.",
    nav: '/contribute',
  },
  {
    keywords: ['fork', 'forking', 'how do i fork'],
    response:
      'Forking lets you propose a correction or alternate interpretation of an existing entity. Open any entity page in the app and click "Fork this" — you\'ll be able to edit specific fields and submit your version for review.',
  },
  {
...
export const FALLBACK_RESPONSE =
  'I can help you explore Nepali cultural heritage or find your way in HeritageGraph. Try asking about a monument, festival, deity, or Guthi — or say "take me to [section]" to open the main app.';
